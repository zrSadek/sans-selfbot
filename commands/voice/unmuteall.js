...
module.exports = {
  name: "unmuteall",
  descriptionfr: "Unmute tous les membres d'un vocal",
  descriptionen: "Unmute all members in vc channel",
  usage: "<channel>",
  premium: true,
  invisible: true,
  run: async (client, message, args) => {
    ...
    channel.members.forEach(m => m.voice.setMute(false).catch(() => false))
    message.edit(`Tous les membres en vocal ont été unmute`)
  }
}