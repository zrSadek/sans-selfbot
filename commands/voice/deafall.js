...
module.exports = {
  name: "deafall",
  descriptionfr: "mute casque tous les membres d'un vocal",
  descriptionen: "Deaf all members in vc channel",
  usage: "<channel>",
  premium: true,
  invisible: true,
  run: async (client, message, args) => {
    ...
    channel.members.forEach(m => m.voice.setDeaf(true).catch(() => false))
    message.edit(`Tous les membres en vocal ont été mute casque`)
}
}