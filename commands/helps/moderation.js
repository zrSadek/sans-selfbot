...
module.exports = {
    name: "moderation",
    descriptionfr: "Des commandes pour faciliter la modération",
    descriptionen: "Controls to facilitate moderation",
    premium: true,
    invisible: true,
    run: async (client, message, args) => {
        ...
        client.db.theme === "ryz" ? message.edit(`# moderation\n## ${client.trad(`moderation commands`, `Commandes moderation`)}\n${commands.map(c => c).join('\n')}`) :
        client.db.theme === "ethone" ? message.edit(`\`\`\`${client.db.name}\`\`\`\`\`\`moderation\`\`\`\`\`\`${commands.map(c => c).join('\n')}\`\`\``) :
        ""
