...
module.exports = {
    name: "fun",
    descriptionfr: "Quelques commandes funs",
    descriptionen: "Some cool commands",
    run: async (client, message, args) => {
        ...
        client.db.theme === "ryz" ? message.edit(`# fun\n## ${client.trad(`fun commands`, `Commandes fun`)}\n${commands.map(c => c).join('\n')}`) :
        client.db.theme === "ethone" ? message.edit(`\`\`\`${client.db.name}\`\`\`\`\`\`fun\`\`\`\`\`\`${commands.map(c => c).join('\n')}\`\`\``) :
        ""
